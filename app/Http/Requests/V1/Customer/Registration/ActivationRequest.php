...
use App\Rules\V1\Customer\Registration\RegistrationTokenRules;

final class ActivationRequest extends ApiRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data.attributes.email' => ['required', 'exists:customers,email', new RegistrationTokenRules()],
        ];
    }
