...
namespace App\Http\Requests\V1\Susu\DailySusu;

use App\Http\Requests\Shared\ApiRequest;

final class DailySusuCreateRequest extends ApiRequest
{
    ...
    public function rules(): array
    {
        return [
            'data' => ['required'],
            'data.type' => ['required', 'string', 'in:DailySusu'],
            ...
            'data.attributes.frequency' => ['in:daily'],
            'data.attributes.rollover_debit' => ['bool'],
    ...
    public function messages(): array
    {
        return [
            ...
            'data.attributes.frequency.in' => 'The frequency is invalid.',
