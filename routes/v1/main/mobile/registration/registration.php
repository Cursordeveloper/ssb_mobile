...
Route::group(['prefix' => 'customers', 'as' => 'customers.'], function (): void {
    ...
    Route::post(uri: 'registrations/verifications', action: RegistrationVerificationController::class)
        ->name(name: 'registrations.verifications');

    // Registration token (new) request route
    Route::post(uri: 'registrations/tokens', action: RegistrationNewTokenController::class)
        ->name(name: 'registrations.tokens');

    // Registration token (new) verification route
    Route::post(uri: '{customer}/registrations/tokens/verifications', action: RegistrationTokenVerificationController::class)
        ->name(name: 'registration.customers.tokens.verifications');

    // Registration personal information route
    Route::post(uri: '{customer}/registrations/personal-information', action: RegistrationPersonalInformationController::class)
    ...
    Route::post(uri: '{customer}/registrations/passwords', action: RegistrationPasswordCreationController::class)
